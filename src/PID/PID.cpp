...
void PID_CALCULATOR(PID_OBJECT_typedef *PID_Object)
{
    ...
    PID_Object->Output = (PID_Object->PIDValue->KP * PID_Object->Error) + (PID_Object->PIDValue->KI * PID_Object->Integral) + (PID_Object->PIDValue->KD * PID_Object->Derivative);
...
void PID_CAL_YAW(PID_OBJECT_typedef *PID_Object)
{
    ...
    if (PID_Object->Error > 180)
        PID_Object->Error -= 360;
    else if (PID_Object->Error < -180)
        PID_Object->Error += 360;
    ...
    PID_Object->Output = (PID_Object->PIDValue->KP_YAW * PID_Object->Error) + (PID_Object->PIDValue->KI_YAW * PID_Object->Integral) + (PID_Object->PIDValue->KD_YAW * PID_Object->Derivative);
